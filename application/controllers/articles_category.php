...
class Articles_category extends CI_Controller {
	 ...
	 */
        ...
        public function __construct()
	 {
		...
		$this->load->model('Model_articles_category');
	...
	{
            $data['meta_title'] = 'articles_category-homepage';
            $data['active'] = 'articles_category-homepage';
            $data['template'] = 'backend/articles_category/index';
	...
	public function add()
	{
        ...
        if($this->input->post('submit'))
        {
            ...
            if($this->form_validation->run())
            {
                ...
                $this->session->set_flashdata('message_flashdata', $flag);
                redirect('articles_category/view');
            }
        }
        $data['active'] = 'articles_category-add';
        $data['meta_title'] = 'articles_category-add';
        $data['template'] = 'backend/articles_category/add';
        $this->load->view('backend/layouts/admin', isset($data) ? $data : NULL);
	}
        // Hàm xóa dữ liệu
