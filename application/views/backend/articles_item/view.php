...
<div class="content-box"><!-- Start Content Box -->
    ...
    <?php
    //Đoạn code hiện thị thông báo success hay error
    echo form_error('checkbox[]','<div class="notification error png_bg"><a href="#" class="close"><img src="template/backend/simpla-admin/resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close"></a><div>','</div></div> '); 
    ...
    ?>
                    ...
                    <form action="" method="POST">
                        <table>
                                            ...
                                            <td colspan="7">
                                                    <div class="bulk-actions align-left">
                                                        ...
                                                        <select name="action" id="select-action">
                                                            ...
                                                            <option value="hide">Ẩn bài viết</option>
                                                            <option value="show">Hiển thị bài viết</option>
                                                        </select>
                                ...
                                <?php
                                    if(isset($list_articles_item) && count($list_articles_item))
                                    {
                                        foreach($list_articles_item as $key => $val)
                                        {
                                            ?>
                                        <tr>
                                            <td><input type="checkbox" name="checkbox[]" value="<?php echo $val['id']; ?>" /></td>
                                            <td><?php echo $val['id']; ?></td>
                                            <td><?php echo htmlspecialchars(cutnchar($val['title'], 50)); ?></td>
                                            ...
                                            <td>
                                                <!-- Icons -->
                                                <a href="index.php/articles_item/edit/<?php echo $val['id']; ?>?redirect=<?php echo base64_encode(fullUrl()); ?>" title="Edit"><img src="template/backend/simpla-admin/resources/images/icons/pencil.png" alt="Edit" /></a>
                                                <a href="index.php/articles_item/del/<?php echo $val['id']; ?>?redirect=<?php echo base64_encode(fullUrl()); ?>" title="Delete"><img src="template/backend/simpla-admin/resources/images/icons/cross.png" alt="Delete" /></a> 
                                            </td>
